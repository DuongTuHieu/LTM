	 ...
	 public static void main(String []args) throws IOException
	    {
	        ...
	        do {
	            outToClient.writeBytes("Mời nhập a: " + '\n');
	            // truyen du lieu tu client vao 2 bien so1 va so2
	            so1 = inFromClient.readLine();
	            outToClient.writeBytes("Mời nhập b: " + '\n');
	            so2 = inFromClient.readLine();
	            outToClient.writeBytes("Mời nhập phép toán: " + '\n');
	            ...
	            outToClient.writeBytes("Bạn có muốn làm tiếp hay không(Co/ko): " + '\n');
